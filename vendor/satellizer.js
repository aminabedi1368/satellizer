...
(function (global, factory) {
    ...
    var Config = (function () {
        function Config() {
            ...
            this.refreshTokenPrefix = 'satellizer';
    ...
    var AuthProvider = (function () {
        ...
        AuthProvider.prototype.$get = function (SatellizerShared, SatellizerLocal, SatellizerOAuth) {
            return {
                ...
                getRefreshToken: function () { return SatellizerShared.getRefreshToken(); },
    ...
    var Shared = (function () {
        function Shared($q, $window, SatellizerConfig, SatellizerStorage) {
            ...
            var _a = this.SatellizerConfig, tokenName = _a.tokenName, tokenPrefix = _a.tokenPrefix,refreshTokenPrefix=_a.refreshTokenPrefix,refreshTokenName=_a.refreshTokenName;
            this.prefixedTokenName = tokenPrefix ? [tokenPrefix, tokenName].join('_') : tokenName;
            this.prefixedRefreshTokenName = refreshTokenPrefix ? [refreshTokenPrefix, refreshTokenName].join('_') : refreshTokenName;
        }
        ...
        Shared.prototype.removeRefreshToken = function () {
            this.SatellizerStorage.remove(this.prefixedRefreshTokenName);
        };
